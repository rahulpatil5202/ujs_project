...
gb1 <- train(x=train_sample7[,1:4], y=train_sample7[,5],method = "gbm",metric = "Accuracy")
...
gb1_stat <- confusionMatrix(predict(gb1,train_sample7,type = "raw"),train_sample7$Species)
...
combined <- cbind(test_data,rf1_p,rf2_p,rp1_p,rp2_p,ld1_p,ld2_p,gb1_p)
...
all_results <- rbind(rf1_stat$overall,rf2_stat$overall,rp1_stat$overall,rp2_stat$overall,ld1_stat$overall,ld2_stat$overall,gb1_stat$overall)
all_results <- as.data.frame(all_results)
all_results$model_name <- c("rf1","rf2","rp1","rp2","ld1","ld2","gb1")
